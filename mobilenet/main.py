...
def train(epoch):
    ...
    with tqdm(total=len(trainloader), unit="batch") as pbar:
        ...
        #               % (train_loss/(batch_idx+1), 100.*correct/total, correct, total))
            ...
            pbar.set_postfix({"train_loss":train_loss/(batch_idx+1) ,"train_accuracy":100*correct/total})
            pbar.update(1)
    ...
    with torch.no_grad(): 
        with tqdm(total=len(testloader), unit="batch") as pbar:
            ...
            #             % (test_loss/(batch_idx+1), 100.*correct/total, correct, total))
                ...
                #pbar.set_postfix({"test_loss":test_loss/(batch_idx+1) ,"test_accuracy":100*correct/total})
                #pbar.update(1)
